...
ALTER TABLE nucleo_financiero.asiento_contable DROP CONSTRAINT IF EXISTS fk_asiento_contable_asiento_reversa_id;
...
ALTER TABLE nucleo_financiero.asiento_contable DROP CONSTRAINT IF EXISTS fk_asiento_contable_grupo_id;
ALTER TABLE nucleo_financiero.asiento_contable
...
ALTER TABLE nucleo_financiero.asiento_contable DROP CONSTRAINT IF EXISTS fk_asiento_contable_periodo_contable_id;
ALTER TABLE nucleo_financiero.asiento_contable
...
ALTER TABLE nucleo_financiero.asiento_contable DROP CONSTRAINT IF EXISTS fk_asiento_contable_registrado_por;
ALTER TABLE nucleo_financiero.asiento_contable
...
ALTER TABLE nucleo_financiero.cierre_diario DROP CONSTRAINT IF EXISTS fk_cierre_diario_cerrado_por;
...
ALTER TABLE aportes.comprobante_manual DROP CONSTRAINT IF EXISTS fk_comprobante_manual_pago_id;
...
ALTER TABLE aportes.comprobante_manual DROP CONSTRAINT IF EXISTS fk_comprobante_manual_revisado_por;
ALTER TABLE aportes.comprobante_manual
...
ALTER TABLE aportes.comprobante_manual DROP CONSTRAINT IF EXISTS fk_comprobante_manual_segunda_revision_por;
ALTER TABLE aportes.comprobante_manual
...
ALTER TABLE aportes.conciliacion DROP CONSTRAINT IF EXISTS fk_conciliacion_conciliado_por;
...
ALTER TABLE aportes.conciliacion DROP CONSTRAINT IF EXISTS fk_conciliacion_movimiento_bancario_id;
ALTER TABLE aportes.conciliacion
...
ALTER TABLE aportes.conciliacion DROP CONSTRAINT IF EXISTS fk_conciliacion_pago_id;
ALTER TABLE aportes.conciliacion
  ADD CONSTRAINT fk_conciliacion_pago_id
  FOREIGN KEY (pago_id) REFERENCES aportes.pago (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE aportes.constancia_pago DROP CONSTRAINT IF EXISTS fk_constancia_pago_pago_id;
ALTER TABLE aportes.constancia_pago
  ADD CONSTRAINT fk_constancia_pago_pago_id
  FOREIGN KEY (pago_id) REFERENCES aportes.pago (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE nucleo_financiero.cuenta_contable DROP CONSTRAINT IF EXISTS fk_cuenta_contable_cuenta_padre_id;
...
ALTER TABLE nucleo_financiero.cuenta_contable DROP CONSTRAINT IF EXISTS fk_cuenta_contable_grupo_id;
ALTER TABLE nucleo_financiero.cuenta_contable
  ADD CONSTRAINT fk_cuenta_contable_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupos.grupo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE nucleo_financiero.cuenta_contable DROP CONSTRAINT IF EXISTS fk_cuenta_contable_participante_id;
ALTER TABLE nucleo_financiero.cuenta_contable
...
ALTER TABLE aportes.disputa_pago DROP CONSTRAINT IF EXISTS fk_disputa_pago_pago_id;
ALTER TABLE aportes.disputa_pago
  ADD CONSTRAINT fk_disputa_pago_pago_id
  FOREIGN KEY (pago_id) REFERENCES aportes.pago (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE aportes.enlace_pago_rapido DROP CONSTRAINT IF EXISTS fk_enlace_pago_rapido_orden_cobro_id;
...
ALTER TABLE aportes.enlace_pago_rapido DROP CONSTRAINT IF EXISTS fk_enlace_pago_rapido_token_id;
ALTER TABLE aportes.enlace_pago_rapido
...
ALTER TABLE aportes.excepcion_conciliacion DROP CONSTRAINT IF EXISTS fk_excepcion_conciliacion_asignada_a;
...
ALTER TABLE aportes.excepcion_conciliacion DROP CONSTRAINT IF EXISTS fk_excepcion_conciliacion_conciliacion_id;
ALTER TABLE aportes.excepcion_conciliacion
...
ALTER TABLE aportes.extracto_bancario DROP CONSTRAINT IF EXISTS fk_extracto_bancario_importado_por;
...
ALTER TABLE aportes.extracto_bancario DROP CONSTRAINT IF EXISTS fk_extracto_bancario_proveedor_id;
ALTER TABLE aportes.extracto_bancario
...
ALTER TABLE aportes.intento_pago DROP CONSTRAINT IF EXISTS fk_intento_pago_orden_cobro_id;
ALTER TABLE aportes.intento_pago
  ADD CONSTRAINT fk_intento_pago_orden_cobro_id
  FOREIGN KEY (orden_cobro_id) REFERENCES aportes.orden_cobro (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE aportes.movimiento_bancario DROP CONSTRAINT IF EXISTS fk_movimiento_bancario_extracto_id;
...
ALTER TABLE nucleo_financiero.movimiento_contable DROP CONSTRAINT IF EXISTS fk_movimiento_contable_asiento_id;
...
ALTER TABLE nucleo_financiero.movimiento_contable DROP CONSTRAINT IF EXISTS fk_movimiento_contable_cuenta_id;
ALTER TABLE nucleo_financiero.movimiento_contable
...
ALTER TABLE aportes.obligacion_aporte DROP CONSTRAINT IF EXISTS fk_obligacion_aporte_cupo_id;
...
ALTER TABLE aportes.obligacion_aporte DROP CONSTRAINT IF EXISTS fk_obligacion_aporte_grupo_id;
ALTER TABLE aportes.obligacion_aporte
...
ALTER TABLE aportes.obligacion_aporte DROP CONSTRAINT IF EXISTS fk_obligacion_aporte_obligacion_origen_id;
ALTER TABLE aportes.obligacion_aporte
...
ALTER TABLE aportes.obligacion_aporte DROP CONSTRAINT IF EXISTS fk_obligacion_aporte_participante_id;
ALTER TABLE aportes.obligacion_aporte
...
ALTER TABLE aportes.obligacion_aporte DROP CONSTRAINT IF EXISTS fk_obligacion_aporte_periodo_id;
ALTER TABLE aportes.obligacion_aporte
...
ALTER TABLE aportes.obligacion_aporte DROP CONSTRAINT IF EXISTS fk_obligacion_aporte_plan_regularizacion_id;
ALTER TABLE aportes.obligacion_aporte
...
ALTER TABLE aportes.obligacion_aporte DROP CONSTRAINT IF EXISTS fk_obligacion_aporte_politica_mora_id;
ALTER TABLE aportes.obligacion_aporte
...
ALTER TABLE aportes.orden_cobro DROP CONSTRAINT IF EXISTS fk_orden_cobro_obligacion_id;
...
ALTER TABLE aportes.orden_cobro DROP CONSTRAINT IF EXISTS fk_orden_cobro_proveedor_id;
ALTER TABLE aportes.orden_cobro
  ADD CONSTRAINT fk_orden_cobro_proveedor_id
  FOREIGN KEY (proveedor_id) REFERENCES aportes.proveedor_pago (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE aportes.pago DROP CONSTRAINT IF EXISTS fk_pago_intento_pago_id;
...
ALTER TABLE aportes.pago DROP CONSTRAINT IF EXISTS fk_pago_obligacion_id;
ALTER TABLE aportes.pago
  ADD CONSTRAINT fk_pago_obligacion_id
  FOREIGN KEY (obligacion_id) REFERENCES aportes.obligacion_aporte (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE aportes.pago DROP CONSTRAINT IF EXISTS fk_pago_proveedor_id;
ALTER TABLE aportes.pago
...
ALTER TABLE aportes.pago DROP CONSTRAINT IF EXISTS fk_pago_registrado_por;
ALTER TABLE aportes.pago
  ADD CONSTRAINT fk_pago_registrado_por
  FOREIGN KEY (registrado_por) REFERENCES identidad.usuario (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE aportes.plan_regularizacion DROP CONSTRAINT IF EXISTS fk_plan_regularizacion_aprobado_por;
...
ALTER TABLE aportes.plan_regularizacion DROP CONSTRAINT IF EXISTS fk_plan_regularizacion_participante_id;
ALTER TABLE aportes.plan_regularizacion
  ADD CONSTRAINT fk_plan_regularizacion_participante_id
  FOREIGN KEY (participante_id) REFERENCES grupos.participante (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE aportes.politica_mora DROP CONSTRAINT IF EXISTS fk_politica_mora_grupo_id;
ALTER TABLE aportes.politica_mora
  ADD CONSTRAINT fk_politica_mora_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupos.grupo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE aportes.qr_cobro DROP CONSTRAINT IF EXISTS fk_qr_cobro_orden_cobro_id;
ALTER TABLE aportes.qr_cobro
  ADD CONSTRAINT fk_qr_cobro_orden_cobro_id
  FOREIGN KEY (orden_cobro_id) REFERENCES aportes.orden_cobro (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE aportes.reembolso DROP CONSTRAINT IF EXISTS fk_reembolso_aprobado_por;
...
ALTER TABLE aportes.reembolso DROP CONSTRAINT IF EXISTS fk_reembolso_pago_id;
ALTER TABLE aportes.reembolso
  ADD CONSTRAINT fk_reembolso_pago_id
  FOREIGN KEY (pago_id) REFERENCES aportes.pago (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE aportes.reembolso DROP CONSTRAINT IF EXISTS fk_reembolso_solicitado_por;
ALTER TABLE aportes.reembolso
...
ALTER TABLE aportes.webhook_pasarela DROP CONSTRAINT IF EXISTS fk_webhook_pasarela_pago_id;
...
ALTER TABLE aportes.webhook_pasarela DROP CONSTRAINT IF EXISTS fk_webhook_pasarela_proveedor_id;
ALTER TABLE aportes.webhook_pasarela
