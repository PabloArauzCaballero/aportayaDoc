...
ALTER TABLE auditoria.alerta_cumplimiento DROP CONSTRAINT IF EXISTS fk_alerta_cumplimiento_analista_id;
...
ALTER TABLE auditoria.alerta_cumplimiento DROP CONSTRAINT IF EXISTS fk_alerta_cumplimiento_grupo_id;
ALTER TABLE auditoria.alerta_cumplimiento
...
ALTER TABLE auditoria.alerta_cumplimiento DROP CONSTRAINT IF EXISTS fk_alerta_cumplimiento_regla_id;
ALTER TABLE auditoria.alerta_cumplimiento
...
ALTER TABLE auditoria.alerta_cumplimiento DROP CONSTRAINT IF EXISTS fk_alerta_cumplimiento_reporte_sospechoso_id;
ALTER TABLE auditoria.alerta_cumplimiento
...
ALTER TABLE auditoria.alerta_cumplimiento DROP CONSTRAINT IF EXISTS fk_alerta_cumplimiento_usuario_id;
ALTER TABLE auditoria.alerta_cumplimiento
...
ALTER TABLE comun.bitacora_evento DROP CONSTRAINT IF EXISTS fk_bitacora_evento_actor_usuario_id;
...
ALTER TABLE comun.bitacora_evento DROP CONSTRAINT IF EXISTS fk_bitacora_evento_grupo_id;
ALTER TABLE comun.bitacora_evento
  ADD CONSTRAINT fk_bitacora_evento_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupos.grupo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE comun.bitacora_evento DROP CONSTRAINT IF EXISTS fk_bitacora_evento_suplantando_a_usuario_id;
ALTER TABLE comun.bitacora_evento
...
ALTER TABLE auditoria.coincidencia_lista DROP CONSTRAINT IF EXISTS fk_coincidencia_lista_lista_id;
...
ALTER TABLE auditoria.coincidencia_lista DROP CONSTRAINT IF EXISTS fk_coincidencia_lista_revisada_por;
ALTER TABLE auditoria.coincidencia_lista
...
ALTER TABLE auditoria.coincidencia_lista DROP CONSTRAINT IF EXISTS fk_coincidencia_lista_usuario_id;
ALTER TABLE auditoria.coincidencia_lista
  ADD CONSTRAINT fk_coincidencia_lista_usuario_id
  FOREIGN KEY (usuario_id) REFERENCES identidad.usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE auditoria.ejecucion_reporte DROP CONSTRAINT IF EXISTS fk_ejecucion_reporte_definicion_id;
...
ALTER TABLE auditoria.ejecucion_reporte DROP CONSTRAINT IF EXISTS fk_ejecucion_reporte_grupo_id;
ALTER TABLE auditoria.ejecucion_reporte
  ADD CONSTRAINT fk_ejecucion_reporte_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupos.grupo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE auditoria.ejecucion_reporte DROP CONSTRAINT IF EXISTS fk_ejecucion_reporte_solicitado_por;
ALTER TABLE auditoria.ejecucion_reporte
...
ALTER TABLE auditoria.exportacion_reporte DROP CONSTRAINT IF EXISTS fk_exportacion_reporte_ejecucion_id;
...
ALTER TABLE auditoria.indicador_kpi DROP CONSTRAINT IF EXISTS fk_indicador_kpi_definicion_indicador_id;
...
ALTER TABLE auditoria.proceso_anonimizacion DROP CONSTRAINT IF EXISTS fk_proceso_anonimizacion_solicitud_id;
...
ALTER TABLE auditoria.proceso_anonimizacion DROP CONSTRAINT IF EXISTS fk_proceso_anonimizacion_usuario_id;
ALTER TABLE auditoria.proceso_anonimizacion
  ADD CONSTRAINT fk_proceso_anonimizacion_usuario_id
  FOREIGN KEY (usuario_id) REFERENCES identidad.usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE auditoria.programacion_reporte DROP CONSTRAINT IF EXISTS fk_programacion_reporte_definicion_id;
ALTER TABLE auditoria.programacion_reporte
  ADD CONSTRAINT fk_programacion_reporte_definicion_id
  FOREIGN KEY (definicion_id) REFERENCES auditoria.definicion_reporte (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE comun.registro_acceso_datos DROP CONSTRAINT IF EXISTS fk_registro_acceso_datos_usuario_afectado_id;
...
ALTER TABLE comun.registro_acceso_datos DROP CONSTRAINT IF EXISTS fk_registro_acceso_datos_usuario_consultor_id;
ALTER TABLE comun.registro_acceso_datos
...
ALTER TABLE auditoria.reporte_operacion_sospechosa DROP CONSTRAINT IF EXISTS fk_reporte_operacion_sospechosa_aprobado_por;
...
ALTER TABLE auditoria.reporte_operacion_sospechosa DROP CONSTRAINT IF EXISTS fk_reporte_operacion_sospechosa_usuario_id;
ALTER TABLE auditoria.reporte_operacion_sospechosa
  ADD CONSTRAINT fk_reporte_operacion_sospechosa_usuario_id
  FOREIGN KEY (usuario_id) REFERENCES identidad.usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE auditoria.solicitud_datos_personales DROP CONSTRAINT IF EXISTS fk_solicitud_datos_personales_atendida_por;
...
ALTER TABLE auditoria.solicitud_datos_personales DROP CONSTRAINT IF EXISTS fk_solicitud_datos_personales_usuario_id;
ALTER TABLE auditoria.solicitud_datos_personales
  ADD CONSTRAINT fk_solicitud_datos_personales_usuario_id
  FOREIGN KEY (usuario_id) REFERENCES identidad.usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE auditoria.ticket_soporte DROP CONSTRAINT IF EXISTS fk_ticket_soporte_asignado_a;
...
ALTER TABLE auditoria.ticket_soporte DROP CONSTRAINT IF EXISTS fk_ticket_soporte_usuario_id;
ALTER TABLE auditoria.ticket_soporte
