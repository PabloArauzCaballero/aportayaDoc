...
ALTER TABLE tarifas.aplicacion_promocion DROP CONSTRAINT IF EXISTS fk_aplicacion_promocion_campana_id;
...
ALTER TABLE tarifas.aplicacion_promocion DROP CONSTRAINT IF EXISTS fk_aplicacion_promocion_devengo_id;
ALTER TABLE tarifas.aplicacion_promocion
...
ALTER TABLE tarifas.asignacion_tarifario DROP CONSTRAINT IF EXISTS fk_asignacion_tarifario_autorizado_por;
...
ALTER TABLE tarifas.asignacion_tarifario DROP CONSTRAINT IF EXISTS fk_asignacion_tarifario_grupo_id;
ALTER TABLE tarifas.asignacion_tarifario
...
ALTER TABLE tarifas.asignacion_tarifario DROP CONSTRAINT IF EXISTS fk_asignacion_tarifario_segmento_id;
ALTER TABLE tarifas.asignacion_tarifario
...
ALTER TABLE tarifas.asignacion_tarifario DROP CONSTRAINT IF EXISTS fk_asignacion_tarifario_tarifario_id;
ALTER TABLE tarifas.asignacion_tarifario
...
ALTER TABLE tarifas.asignacion_tarifario DROP CONSTRAINT IF EXISTS fk_asignacion_tarifario_usuario_id;
ALTER TABLE tarifas.asignacion_tarifario
...
ALTER TABLE tarifas.calculo_impuesto DROP CONSTRAINT IF EXISTS fk_calculo_impuesto_devengo_id;
ALTER TABLE tarifas.calculo_impuesto
  ADD CONSTRAINT fk_calculo_impuesto_devengo_id
  FOREIGN KEY (devengo_id) REFERENCES tarifas.devengo_comision (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE tarifas.calculo_impuesto DROP CONSTRAINT IF EXISTS fk_calculo_impuesto_impuesto_id;
ALTER TABLE tarifas.calculo_impuesto
...
ALTER TABLE tarifas.cambio_tarifario DROP CONSTRAINT IF EXISTS fk_cambio_tarifario_aprobado_por;
...
ALTER TABLE tarifas.cambio_tarifario DROP CONSTRAINT IF EXISTS fk_cambio_tarifario_tarifario_anterior_id;
ALTER TABLE tarifas.cambio_tarifario
...
ALTER TABLE tarifas.cambio_tarifario DROP CONSTRAINT IF EXISTS fk_cambio_tarifario_tarifario_nuevo_id;
ALTER TABLE tarifas.cambio_tarifario
...
ALTER TABLE tarifas.campana_promocional DROP CONSTRAINT IF EXISTS fk_campana_promocional_aprobada_por;
...
ALTER TABLE tarifas.cargo_comision DROP CONSTRAINT IF EXISTS fk_cargo_comision_deduccion_entrega_id;
...
ALTER TABLE tarifas.cargo_comision DROP CONSTRAINT IF EXISTS fk_cargo_comision_devengo_id;
ALTER TABLE tarifas.cargo_comision
  ADD CONSTRAINT fk_cargo_comision_devengo_id
  FOREIGN KEY (devengo_id) REFERENCES tarifas.devengo_comision (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE tarifas.cargo_comision DROP CONSTRAINT IF EXISTS fk_cargo_comision_obligacion_id;
ALTER TABLE tarifas.cargo_comision
...
ALTER TABLE tarifas.cargo_comision DROP CONSTRAINT IF EXISTS fk_cargo_comision_transaccion_id;
ALTER TABLE tarifas.cargo_comision
...
ALTER TABLE tarifas.concepto_tarifa DROP CONSTRAINT IF EXISTS fk_concepto_tarifa_cuenta_ingreso_id;
...
ALTER TABLE tarifas.concepto_tarifa DROP CONSTRAINT IF EXISTS fk_concepto_tarifa_hecho_generador_id;
ALTER TABLE tarifas.concepto_tarifa
...
ALTER TABLE tarifas.concepto_tarifa DROP CONSTRAINT IF EXISTS fk_concepto_tarifa_politica_redondeo_id;
ALTER TABLE tarifas.concepto_tarifa
...
ALTER TABLE tarifas.concepto_tarifa DROP CONSTRAINT IF EXISTS fk_concepto_tarifa_tarifario_id;
ALTER TABLE tarifas.concepto_tarifa
  ADD CONSTRAINT fk_concepto_tarifa_tarifario_id
  FOREIGN KEY (tarifario_id) REFERENCES catalogo.tarifario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE tarifas.costo_proveedor_operacion DROP CONSTRAINT IF EXISTS fk_costo_proveedor_operacion_liquidacion_ingresos_id;
...
ALTER TABLE tarifas.costo_proveedor_operacion DROP CONSTRAINT IF EXISTS fk_costo_proveedor_operacion_proveedor_id;
ALTER TABLE tarifas.costo_proveedor_operacion
...
ALTER TABLE tarifas.costo_proveedor_operacion DROP CONSTRAINT IF EXISTS fk_costo_proveedor_operacion_transaccion_id;
ALTER TABLE tarifas.costo_proveedor_operacion
  ADD CONSTRAINT fk_costo_proveedor_operacion_transaccion_id
  FOREIGN KEY (transaccion_id) REFERENCES nucleo_financiero.transaccion_billetera (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE tarifas.cotizacion_comision DROP CONSTRAINT IF EXISTS fk_cotizacion_comision_concepto_tarifa_id;
...
ALTER TABLE tarifas.cotizacion_comision DROP CONSTRAINT IF EXISTS fk_cotizacion_comision_tarifario_id;
ALTER TABLE tarifas.cotizacion_comision
  ADD CONSTRAINT fk_cotizacion_comision_tarifario_id
  FOREIGN KEY (tarifario_id) REFERENCES catalogo.tarifario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE tarifas.cuenta_por_cobrar_comision DROP CONSTRAINT IF EXISTS fk_cuenta_por_cobrar_comision_devengo_id;
ALTER TABLE tarifas.cuenta_por_cobrar_comision
  ADD CONSTRAINT fk_cuenta_por_cobrar_comision_devengo_id
  FOREIGN KEY (devengo_id) REFERENCES tarifas.devengo_comision (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE tarifas.cuenta_por_cobrar_comision DROP CONSTRAINT IF EXISTS fk_cuenta_por_cobrar_comision_gestion_cobranza_id;
ALTER TABLE tarifas.cuenta_por_cobrar_comision
...
ALTER TABLE tarifas.cuenta_por_cobrar_comision DROP CONSTRAINT IF EXISTS fk_cuenta_por_cobrar_comision_usuario_id;
ALTER TABLE tarifas.cuenta_por_cobrar_comision
...
ALTER TABLE tarifas.datos_facturacion DROP CONSTRAINT IF EXISTS fk_datos_facturacion_usuario_id;
ALTER TABLE tarifas.datos_facturacion
  ADD CONSTRAINT fk_datos_facturacion_usuario_id
  FOREIGN KEY (usuario_id) REFERENCES identidad.usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE tarifas.devengo_comision DROP CONSTRAINT IF EXISTS fk_devengo_comision_asiento_contable_id;
...
ALTER TABLE tarifas.devengo_comision DROP CONSTRAINT IF EXISTS fk_devengo_comision_concepto_tarifa_id;
ALTER TABLE tarifas.devengo_comision
  ADD CONSTRAINT fk_devengo_comision_concepto_tarifa_id
  FOREIGN KEY (concepto_tarifa_id) REFERENCES tarifas.concepto_tarifa (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE tarifas.devengo_comision DROP CONSTRAINT IF EXISTS fk_devengo_comision_cotizacion_id;
ALTER TABLE tarifas.devengo_comision
...
ALTER TABLE tarifas.devengo_comision DROP CONSTRAINT IF EXISTS fk_devengo_comision_grupo_id;
ALTER TABLE tarifas.devengo_comision
  ADD CONSTRAINT fk_devengo_comision_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupos.grupo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE tarifas.devengo_comision DROP CONSTRAINT IF EXISTS fk_devengo_comision_participante_id;
ALTER TABLE tarifas.devengo_comision
...
ALTER TABLE tarifas.devengo_comision DROP CONSTRAINT IF EXISTS fk_devengo_comision_tarifario_id;
ALTER TABLE tarifas.devengo_comision
  ADD CONSTRAINT fk_devengo_comision_tarifario_id
  FOREIGN KEY (tarifario_id) REFERENCES catalogo.tarifario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE tarifas.devengo_comision DROP CONSTRAINT IF EXISTS fk_devengo_comision_usuario_obligado_id;
ALTER TABLE tarifas.devengo_comision
...
ALTER TABLE tarifas.devolucion_comision DROP CONSTRAINT IF EXISTS fk_devolucion_comision_autorizada_por;
...
ALTER TABLE tarifas.devolucion_comision DROP CONSTRAINT IF EXISTS fk_devolucion_comision_devengo_id;
ALTER TABLE tarifas.devolucion_comision
  ADD CONSTRAINT fk_devolucion_comision_devengo_id
  FOREIGN KEY (devengo_id) REFERENCES tarifas.devengo_comision (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE tarifas.devolucion_comision DROP CONSTRAINT IF EXISTS fk_devolucion_comision_reclamo_id;
ALTER TABLE tarifas.devolucion_comision
...
ALTER TABLE tarifas.devolucion_comision DROP CONSTRAINT IF EXISTS fk_devolucion_comision_transaccion_id;
ALTER TABLE tarifas.devolucion_comision
  ADD CONSTRAINT fk_devolucion_comision_transaccion_id
  FOREIGN KEY (transaccion_id) REFERENCES nucleo_financiero.transaccion_billetera (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE tarifas.evento_significativo_sin DROP CONSTRAINT IF EXISTS fk_evento_significativo_sin_registrado_por;
...
ALTER TABLE tarifas.exencion_comision DROP CONSTRAINT IF EXISTS fk_exencion_comision_autorizada_por;
ALTER TABLE tarifas.exencion_comision
  ADD CONSTRAINT fk_exencion_comision_autorizada_por
  FOREIGN KEY (autorizada_por) REFERENCES identidad.usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE tarifas.exencion_comision DROP CONSTRAINT IF EXISTS fk_exencion_comision_concepto_tarifa_id;
ALTER TABLE tarifas.exencion_comision
...
ALTER TABLE tarifas.exencion_comision DROP CONSTRAINT IF EXISTS fk_exencion_comision_grupo_id;
ALTER TABLE tarifas.exencion_comision
  ADD CONSTRAINT fk_exencion_comision_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupos.grupo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE tarifas.exencion_comision DROP CONSTRAINT IF EXISTS fk_exencion_comision_segmento_id;
ALTER TABLE tarifas.exencion_comision
  ADD CONSTRAINT fk_exencion_comision_segmento_id
  FOREIGN KEY (segmento_id) REFERENCES tarifas.segmento_comercial (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE tarifas.exencion_comision DROP CONSTRAINT IF EXISTS fk_exencion_comision_usuario_id;
ALTER TABLE tarifas.exencion_comision
  ADD CONSTRAINT fk_exencion_comision_usuario_id
  FOREIGN KEY (usuario_id) REFERENCES identidad.usuario (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE tarifas.factura_electronica DROP CONSTRAINT IF EXISTS fk_factura_electronica_datos_facturacion_id;
...
ALTER TABLE tarifas.factura_electronica DROP CONSTRAINT IF EXISTS fk_factura_electronica_devengo_id;
ALTER TABLE tarifas.factura_electronica
...
ALTER TABLE tarifas.factura_electronica DROP CONSTRAINT IF EXISTS fk_factura_electronica_evento_significativo_id;
ALTER TABLE tarifas.factura_electronica
...
ALTER TABLE tarifas.factura_electronica DROP CONSTRAINT IF EXISTS fk_factura_electronica_lote_envio_sin_id;
ALTER TABLE tarifas.factura_electronica
...
ALTER TABLE tarifas.factura_electronica DROP CONSTRAINT IF EXISTS fk_factura_electronica_usuario_id;
ALTER TABLE tarifas.factura_electronica
  ADD CONSTRAINT fk_factura_electronica_usuario_id
  FOREIGN KEY (usuario_id) REFERENCES identidad.usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE catalogo.impuesto DROP CONSTRAINT IF EXISTS fk_impuesto_cuenta_contable_id;
...
ALTER TABLE tarifas.liquidacion_ingresos DROP CONSTRAINT IF EXISTS fk_liquidacion_ingresos_asiento_contable_id;
ALTER TABLE tarifas.liquidacion_ingresos
  ADD CONSTRAINT fk_liquidacion_ingresos_asiento_contable_id
  FOREIGN KEY (asiento_contable_id) REFERENCES nucleo_financiero.asiento_contable (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE tarifas.liquidacion_ingresos DROP CONSTRAINT IF EXISTS fk_liquidacion_ingresos_cerrada_por;
ALTER TABLE tarifas.liquidacion_ingresos
...
ALTER TABLE tarifas.nota_credito_debito DROP CONSTRAINT IF EXISTS fk_nota_credito_debito_devolucion_comision_id;
...
ALTER TABLE tarifas.nota_credito_debito DROP CONSTRAINT IF EXISTS fk_nota_credito_debito_factura_id;
ALTER TABLE tarifas.nota_credito_debito
...
ALTER TABLE tarifas.regla_tarifa DROP CONSTRAINT IF EXISTS fk_regla_tarifa_concepto_tarifa_id;
ALTER TABLE tarifas.regla_tarifa
  ADD CONSTRAINT fk_regla_tarifa_concepto_tarifa_id
  FOREIGN KEY (concepto_tarifa_id) REFERENCES tarifas.concepto_tarifa (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE tarifas.simulacion_tarifa DROP CONSTRAINT IF EXISTS fk_simulacion_tarifa_ejecutada_por;
...
ALTER TABLE tarifas.simulacion_tarifa DROP CONSTRAINT IF EXISTS fk_simulacion_tarifa_tarifario_id;
ALTER TABLE tarifas.simulacion_tarifa
  ADD CONSTRAINT fk_simulacion_tarifa_tarifario_id
  FOREIGN KEY (tarifario_id) REFERENCES catalogo.tarifario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE tarifas.tarifa_congelada_grupo DROP CONSTRAINT IF EXISTS fk_tarifa_congelada_grupo_acuerdo_id;
...
ALTER TABLE tarifas.tarifa_congelada_grupo DROP CONSTRAINT IF EXISTS fk_tarifa_congelada_grupo_grupo_id;
ALTER TABLE tarifas.tarifa_congelada_grupo
...
ALTER TABLE tarifas.tarifa_congelada_grupo DROP CONSTRAINT IF EXISTS fk_tarifa_congelada_grupo_tarifario_id;
ALTER TABLE tarifas.tarifa_congelada_grupo
  ADD CONSTRAINT fk_tarifa_congelada_grupo_tarifario_id
  FOREIGN KEY (tarifario_id) REFERENCES catalogo.tarifario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE catalogo.tarifario DROP CONSTRAINT IF EXISTS fk_tarifario_aprobado_por;
...
ALTER TABLE catalogo.tarifario DROP CONSTRAINT IF EXISTS fk_tarifario_tarifario_anterior_id;
ALTER TABLE catalogo.tarifario
