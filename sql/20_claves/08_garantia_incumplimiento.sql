...
ALTER TABLE garantia.abono_recuperacion DROP CONSTRAINT IF EXISTS fk_abono_recuperacion_deuda_id;
...
ALTER TABLE garantia.abono_recuperacion DROP CONSTRAINT IF EXISTS fk_abono_recuperacion_entrega_id;
ALTER TABLE garantia.abono_recuperacion
...
ALTER TABLE garantia.abono_recuperacion DROP CONSTRAINT IF EXISTS fk_abono_recuperacion_movimiento_fondo_id;
ALTER TABLE garantia.abono_recuperacion
...
ALTER TABLE garantia.abono_recuperacion DROP CONSTRAINT IF EXISTS fk_abono_recuperacion_pago_id;
ALTER TABLE garantia.abono_recuperacion
...
ALTER TABLE garantia.abono_recuperacion DROP CONSTRAINT IF EXISTS fk_abono_recuperacion_registrado_por;
ALTER TABLE garantia.abono_recuperacion
...
ALTER TABLE garantia.accion_cobranza DROP CONSTRAINT IF EXISTS fk_accion_cobranza_ejecutada_por;
...
ALTER TABLE garantia.accion_cobranza DROP CONSTRAINT IF EXISTS fk_accion_cobranza_gestion_id;
ALTER TABLE garantia.accion_cobranza
...
ALTER TABLE garantia.accion_cobranza DROP CONSTRAINT IF EXISTS fk_accion_cobranza_notificacion_id;
ALTER TABLE garantia.accion_cobranza
...
ALTER TABLE garantia.acuerdo_quita DROP CONSTRAINT IF EXISTS fk_acuerdo_quita_acuerdo_grupo_id;
...
ALTER TABLE garantia.acuerdo_quita DROP CONSTRAINT IF EXISTS fk_acuerdo_quita_aprobado_por;
ALTER TABLE garantia.acuerdo_quita
...
ALTER TABLE garantia.acuerdo_quita DROP CONSTRAINT IF EXISTS fk_acuerdo_quita_registro_id;
ALTER TABLE garantia.acuerdo_quita
...
ALTER TABLE garantia.alerta_temprana DROP CONSTRAINT IF EXISTS fk_alerta_temprana_grupo_id;
...
ALTER TABLE garantia.alerta_temprana DROP CONSTRAINT IF EXISTS fk_alerta_temprana_usuario_id;
ALTER TABLE garantia.alerta_temprana
...
ALTER TABLE garantia.apelacion_sancion DROP CONSTRAINT IF EXISTS fk_apelacion_sancion_apelante_id;
...
ALTER TABLE garantia.apelacion_sancion DROP CONSTRAINT IF EXISTS fk_apelacion_sancion_resuelta_por;
ALTER TABLE garantia.apelacion_sancion
...
ALTER TABLE garantia.apelacion_sancion DROP CONSTRAINT IF EXISTS fk_apelacion_sancion_sancion_id;
ALTER TABLE garantia.apelacion_sancion
...
ALTER TABLE garantia.aval_participante DROP CONSTRAINT IF EXISTS fk_aval_participante_avalista_usuario_id;
...
ALTER TABLE garantia.aval_participante DROP CONSTRAINT IF EXISTS fk_aval_participante_grupo_id;
ALTER TABLE garantia.aval_participante
...
ALTER TABLE garantia.aval_participante DROP CONSTRAINT IF EXISTS fk_aval_participante_participante_avalado_id;
ALTER TABLE garantia.aval_participante
...
ALTER TABLE garantia.aval_participante DROP CONSTRAINT IF EXISTS fk_aval_participante_token_aceptacion_id;
ALTER TABLE garantia.aval_participante
...
ALTER TABLE garantia.candidato_reemplazo DROP CONSTRAINT IF EXISTS fk_candidato_reemplazo_reemplazo_id;
...
ALTER TABLE garantia.candidato_reemplazo DROP CONSTRAINT IF EXISTS fk_candidato_reemplazo_usuario_id;
ALTER TABLE garantia.candidato_reemplazo
...
ALTER TABLE garantia.castigo_deuda DROP CONSTRAINT IF EXISTS fk_castigo_deuda_asiento_contable_id;
ALTER TABLE garantia.castigo_deuda
...
ALTER TABLE garantia.castigo_deuda DROP CONSTRAINT IF EXISTS fk_castigo_deuda_deuda_id;
ALTER TABLE garantia.castigo_deuda
  ADD CONSTRAINT fk_castigo_deuda_deuda_id
  FOREIGN KEY (deuda_id) REFERENCES garantia.deuda_participante (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.cobertura_incumplimiento DROP CONSTRAINT IF EXISTS fk_cobertura_incumplimiento_aprobada_por;
...
ALTER TABLE garantia.cobertura_incumplimiento DROP CONSTRAINT IF EXISTS fk_cobertura_incumplimiento_asiento_contable_id;
ALTER TABLE garantia.cobertura_incumplimiento
  ADD CONSTRAINT fk_cobertura_incumplimiento_asiento_contable_id
  FOREIGN KEY (asiento_contable_id) REFERENCES nucleo_financiero.asiento_contable (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE garantia.cobertura_incumplimiento DROP CONSTRAINT IF EXISTS fk_cobertura_incumplimiento_fondo_id;
ALTER TABLE garantia.cobertura_incumplimiento
...
ALTER TABLE garantia.cobertura_incumplimiento DROP CONSTRAINT IF EXISTS fk_cobertura_incumplimiento_movimiento_fondo_id;
ALTER TABLE garantia.cobertura_incumplimiento
  ADD CONSTRAINT fk_cobertura_incumplimiento_movimiento_fondo_id
  FOREIGN KEY (movimiento_fondo_id) REFERENCES garantia.movimiento_fondo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE garantia.cobertura_incumplimiento DROP CONSTRAINT IF EXISTS fk_cobertura_incumplimiento_obligacion_id;
ALTER TABLE garantia.cobertura_incumplimiento
...
ALTER TABLE garantia.cobertura_incumplimiento DROP CONSTRAINT IF EXISTS fk_cobertura_incumplimiento_periodo_id;
ALTER TABLE garantia.cobertura_incumplimiento
...
ALTER TABLE garantia.cobertura_incumplimiento DROP CONSTRAINT IF EXISTS fk_cobertura_incumplimiento_registro_id;
ALTER TABLE garantia.cobertura_incumplimiento
...
ALTER TABLE garantia.descargo_participante DROP CONSTRAINT IF EXISTS fk_descargo_participante_registro_id;
ALTER TABLE garantia.descargo_participante
  ADD CONSTRAINT fk_descargo_participante_registro_id
  FOREIGN KEY (registro_id) REFERENCES garantia.registro_incumplimiento (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.descargo_participante DROP CONSTRAINT IF EXISTS fk_descargo_participante_resuelto_por;
ALTER TABLE garantia.descargo_participante
...
ALTER TABLE garantia.deuda_participante DROP CONSTRAINT IF EXISTS fk_deuda_participante_cobertura_id;
...
ALTER TABLE garantia.deuda_participante DROP CONSTRAINT IF EXISTS fk_deuda_participante_grupo_id;
ALTER TABLE garantia.deuda_participante
  ADD CONSTRAINT fk_deuda_participante_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupos.grupo (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.deuda_participante DROP CONSTRAINT IF EXISTS fk_deuda_participante_participante_id;
ALTER TABLE garantia.deuda_participante
  ADD CONSTRAINT fk_deuda_participante_participante_id
  FOREIGN KEY (participante_id) REFERENCES grupos.participante (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.deuda_participante DROP CONSTRAINT IF EXISTS fk_deuda_participante_registro_id;
ALTER TABLE garantia.deuda_participante
  ADD CONSTRAINT fk_deuda_participante_registro_id
  FOREIGN KEY (registro_id) REFERENCES garantia.registro_incumplimiento (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.deuda_participante DROP CONSTRAINT IF EXISTS fk_deuda_participante_usuario_id;
ALTER TABLE garantia.deuda_participante
  ADD CONSTRAINT fk_deuda_participante_usuario_id
  FOREIGN KEY (usuario_id) REFERENCES identidad.usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.devolucion_fondo DROP CONSTRAINT IF EXISTS fk_devolucion_fondo_fondo_id;
ALTER TABLE garantia.devolucion_fondo
  ADD CONSTRAINT fk_devolucion_fondo_fondo_id
  FOREIGN KEY (fondo_id) REFERENCES garantia.fondo_garantia (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.devolucion_fondo DROP CONSTRAINT IF EXISTS fk_devolucion_fondo_participante_id;
ALTER TABLE garantia.devolucion_fondo
  ADD CONSTRAINT fk_devolucion_fondo_participante_id
  FOREIGN KEY (participante_id) REFERENCES grupos.participante (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.disolucion_anticipada DROP CONSTRAINT IF EXISTS fk_disolucion_anticipada_acuerdo_grupo_id;
ALTER TABLE garantia.disolucion_anticipada
  ADD CONSTRAINT fk_disolucion_anticipada_acuerdo_grupo_id
  FOREIGN KEY (acuerdo_grupo_id) REFERENCES grupos.acuerdo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE garantia.disolucion_anticipada DROP CONSTRAINT IF EXISTS fk_disolucion_anticipada_grupo_id;
ALTER TABLE garantia.disolucion_anticipada
  ADD CONSTRAINT fk_disolucion_anticipada_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupos.grupo (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.ejecucion_aval DROP CONSTRAINT IF EXISTS fk_ejecucion_aval_aval_id;
...
ALTER TABLE garantia.ejecucion_aval DROP CONSTRAINT IF EXISTS fk_ejecucion_aval_deuda_id;
ALTER TABLE garantia.ejecucion_aval
  ADD CONSTRAINT fk_ejecucion_aval_deuda_id
  FOREIGN KEY (deuda_id) REFERENCES garantia.deuda_participante (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.ejecucion_aval DROP CONSTRAINT IF EXISTS fk_ejecucion_aval_pago_id;
ALTER TABLE garantia.ejecucion_aval
  ADD CONSTRAINT fk_ejecucion_aval_pago_id
  FOREIGN KEY (pago_id) REFERENCES aportes.pago (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE garantia.ejecucion_aval DROP CONSTRAINT IF EXISTS fk_ejecucion_aval_registro_id;
ALTER TABLE garantia.ejecucion_aval
  ADD CONSTRAINT fk_ejecucion_aval_registro_id
  FOREIGN KEY (registro_id) REFERENCES garantia.registro_incumplimiento (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.evidencia_incumplimiento DROP CONSTRAINT IF EXISTS fk_evidencia_incumplimiento_aportada_por;
...
ALTER TABLE garantia.evidencia_incumplimiento DROP CONSTRAINT IF EXISTS fk_evidencia_incumplimiento_registro_id;
ALTER TABLE garantia.evidencia_incumplimiento
  ADD CONSTRAINT fk_evidencia_incumplimiento_registro_id
  FOREIGN KEY (registro_id) REFERENCES garantia.registro_incumplimiento (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.fondo_garantia DROP CONSTRAINT IF EXISTS fk_fondo_garantia_cuenta_contable_id;
...
ALTER TABLE garantia.fondo_garantia DROP CONSTRAINT IF EXISTS fk_fondo_garantia_grupo_id;
ALTER TABLE garantia.fondo_garantia
  ADD CONSTRAINT fk_fondo_garantia_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupos.grupo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE garantia.fondo_garantia DROP CONSTRAINT IF EXISTS fk_fondo_garantia_politica_cobertura_id;
ALTER TABLE garantia.fondo_garantia
...
ALTER TABLE garantia.gestion_cobranza DROP CONSTRAINT IF EXISTS fk_gestion_cobranza_estrategia_id;
...
ALTER TABLE garantia.gestion_cobranza DROP CONSTRAINT IF EXISTS fk_gestion_cobranza_gestor_asignado_id;
ALTER TABLE garantia.gestion_cobranza
...
ALTER TABLE garantia.gestion_cobranza DROP CONSTRAINT IF EXISTS fk_gestion_cobranza_registro_id;
ALTER TABLE garantia.gestion_cobranza
  ADD CONSTRAINT fk_gestion_cobranza_registro_id
  FOREIGN KEY (registro_id) REFERENCES garantia.registro_incumplimiento (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.historial_estado_incumplimiento DROP CONSTRAINT IF EXISTS fk_historial_estado_incumplimiento_ejecutado_por;
...
ALTER TABLE garantia.historial_estado_incumplimiento DROP CONSTRAINT IF EXISTS fk_historial_estado_incumplimiento_registro_id;
ALTER TABLE garantia.historial_estado_incumplimiento
  ADD CONSTRAINT fk_historial_estado_incumplimiento_registro_id
  FOREIGN KEY (registro_id) REFERENCES garantia.registro_incumplimiento (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.historial_incumplimiento_usuario DROP CONSTRAINT IF EXISTS fk_historial_incumplimiento_usuario_usuario_id;
ALTER TABLE garantia.historial_incumplimiento_usuario
  ADD CONSTRAINT fk_historial_incumplimiento_usuario_usuario_id
  FOREIGN KEY (usuario_id) REFERENCES identidad.usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.liquidacion_participante DROP CONSTRAINT IF EXISTS fk_liquidacion_participante_disolucion_id;
...
ALTER TABLE garantia.liquidacion_participante DROP CONSTRAINT IF EXISTS fk_liquidacion_participante_participante_id;
ALTER TABLE garantia.liquidacion_participante
  ADD CONSTRAINT fk_liquidacion_participante_participante_id
  FOREIGN KEY (participante_id) REFERENCES grupos.participante (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.lista_restriccion_interna DROP CONSTRAINT IF EXISTS fk_lista_restriccion_interna_registro_origen_id;
...
ALTER TABLE garantia.lista_restriccion_interna DROP CONSTRAINT IF EXISTS fk_lista_restriccion_interna_retirado_por;
ALTER TABLE garantia.lista_restriccion_interna
...
ALTER TABLE garantia.lista_restriccion_interna DROP CONSTRAINT IF EXISTS fk_lista_restriccion_interna_usuario_id;
ALTER TABLE garantia.lista_restriccion_interna
  ADD CONSTRAINT fk_lista_restriccion_interna_usuario_id
  FOREIGN KEY (usuario_id) REFERENCES identidad.usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.matriz_sancion DROP CONSTRAINT IF EXISTS fk_matriz_sancion_politica_id;
...
ALTER TABLE garantia.movimiento_fondo DROP CONSTRAINT IF EXISTS fk_movimiento_fondo_asiento_contable_id;
ALTER TABLE garantia.movimiento_fondo
  ADD CONSTRAINT fk_movimiento_fondo_asiento_contable_id
  FOREIGN KEY (asiento_contable_id) REFERENCES nucleo_financiero.asiento_contable (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE garantia.movimiento_fondo DROP CONSTRAINT IF EXISTS fk_movimiento_fondo_fondo_id;
ALTER TABLE garantia.movimiento_fondo
  ADD CONSTRAINT fk_movimiento_fondo_fondo_id
  FOREIGN KEY (fondo_id) REFERENCES garantia.fondo_garantia (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.movimiento_fondo DROP CONSTRAINT IF EXISTS fk_movimiento_fondo_registrado_por;
ALTER TABLE garantia.movimiento_fondo
...
ALTER TABLE garantia.plan_contingencia DROP CONSTRAINT IF EXISTS fk_plan_contingencia_grupo_id;
ALTER TABLE garantia.plan_contingencia
  ADD CONSTRAINT fk_plan_contingencia_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupos.grupo (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.politica_cobertura DROP CONSTRAINT IF EXISTS fk_politica_cobertura_grupo_id;
ALTER TABLE garantia.politica_cobertura
  ADD CONSTRAINT fk_politica_cobertura_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupos.grupo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE garantia.politica_sancion DROP CONSTRAINT IF EXISTS fk_politica_sancion_grupo_id;
ALTER TABLE garantia.politica_sancion
  ADD CONSTRAINT fk_politica_sancion_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupos.grupo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE garantia.promesa_pago DROP CONSTRAINT IF EXISTS fk_promesa_pago_gestion_id;
ALTER TABLE garantia.promesa_pago
  ADD CONSTRAINT fk_promesa_pago_gestion_id
  FOREIGN KEY (gestion_id) REFERENCES garantia.gestion_cobranza (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.promesa_pago DROP CONSTRAINT IF EXISTS fk_promesa_pago_registrada_por;
ALTER TABLE garantia.promesa_pago
...
ALTER TABLE garantia.reemplazo_participante DROP CONSTRAINT IF EXISTS fk_reemplazo_participante_cupo_id;
ALTER TABLE garantia.reemplazo_participante
...
ALTER TABLE garantia.reemplazo_participante DROP CONSTRAINT IF EXISTS fk_reemplazo_participante_grupo_id;
ALTER TABLE garantia.reemplazo_participante
  ADD CONSTRAINT fk_reemplazo_participante_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupos.grupo (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.reemplazo_participante DROP CONSTRAINT IF EXISTS fk_reemplazo_participante_participante_entrante_id;
ALTER TABLE garantia.reemplazo_participante
...
ALTER TABLE garantia.reemplazo_participante DROP CONSTRAINT IF EXISTS fk_reemplazo_participante_participante_saliente_id;
ALTER TABLE garantia.reemplazo_participante
...
ALTER TABLE garantia.reemplazo_participante DROP CONSTRAINT IF EXISTS fk_reemplazo_participante_registro_id;
ALTER TABLE garantia.reemplazo_participante
...
ALTER TABLE garantia.registro_incumplimiento DROP CONSTRAINT IF EXISTS fk_registro_incumplimiento_cupo_id;
...
ALTER TABLE garantia.registro_incumplimiento DROP CONSTRAINT IF EXISTS fk_registro_incumplimiento_entrega_afectada_id;
ALTER TABLE garantia.registro_incumplimiento
...
ALTER TABLE garantia.registro_incumplimiento DROP CONSTRAINT IF EXISTS fk_registro_incumplimiento_grupo_id;
ALTER TABLE garantia.registro_incumplimiento
  ADD CONSTRAINT fk_registro_incumplimiento_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupos.grupo (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.registro_incumplimiento DROP CONSTRAINT IF EXISTS fk_registro_incumplimiento_obligacion_id;
ALTER TABLE garantia.registro_incumplimiento
...
ALTER TABLE garantia.registro_incumplimiento DROP CONSTRAINT IF EXISTS fk_registro_incumplimiento_participante_id;
ALTER TABLE garantia.registro_incumplimiento
  ADD CONSTRAINT fk_registro_incumplimiento_participante_id
  FOREIGN KEY (participante_id) REFERENCES grupos.participante (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.registro_incumplimiento DROP CONSTRAINT IF EXISTS fk_registro_incumplimiento_periodo_id;
ALTER TABLE garantia.registro_incumplimiento
...
ALTER TABLE garantia.registro_incumplimiento DROP CONSTRAINT IF EXISTS fk_registro_incumplimiento_reportado_por;
ALTER TABLE garantia.registro_incumplimiento
...
ALTER TABLE garantia.registro_incumplimiento DROP CONSTRAINT IF EXISTS fk_registro_incumplimiento_responsable_gestion;
ALTER TABLE garantia.registro_incumplimiento
...
ALTER TABLE garantia.registro_incumplimiento DROP CONSTRAINT IF EXISTS fk_registro_incumplimiento_usuario_id;
ALTER TABLE garantia.registro_incumplimiento
...
ALTER TABLE garantia.sancion DROP CONSTRAINT IF EXISTS fk_sancion_aplicada_por;
ALTER TABLE garantia.sancion
...
ALTER TABLE garantia.sancion DROP CONSTRAINT IF EXISTS fk_sancion_matriz_id;
ALTER TABLE garantia.sancion
...
ALTER TABLE garantia.sancion DROP CONSTRAINT IF EXISTS fk_sancion_participante_id;
ALTER TABLE garantia.sancion
...
ALTER TABLE garantia.sancion DROP CONSTRAINT IF EXISTS fk_sancion_registro_id;
ALTER TABLE garantia.sancion
  ADD CONSTRAINT fk_sancion_registro_id
  FOREIGN KEY (registro_id) REFERENCES garantia.registro_incumplimiento (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.sancion DROP CONSTRAINT IF EXISTS fk_sancion_usuario_id;
ALTER TABLE garantia.sancion
  ADD CONSTRAINT fk_sancion_usuario_id
  FOREIGN KEY (usuario_id) REFERENCES identidad.usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.score_riesgo_incumplimiento DROP CONSTRAINT IF EXISTS fk_score_riesgo_incumplimiento_grupo_id;
ALTER TABLE garantia.score_riesgo_incumplimiento
  ADD CONSTRAINT fk_score_riesgo_incumplimiento_grupo_id
  FOREIGN KEY (grupo_id) REFERENCES grupos.grupo (id) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE garantia.score_riesgo_incumplimiento DROP CONSTRAINT IF EXISTS fk_score_riesgo_incumplimiento_usuario_id;
ALTER TABLE garantia.score_riesgo_incumplimiento
  ADD CONSTRAINT fk_score_riesgo_incumplimiento_usuario_id
  FOREIGN KEY (usuario_id) REFERENCES identidad.usuario (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE garantia.subrogacion DROP CONSTRAINT IF EXISTS fk_subrogacion_cobertura_id;
...
ALTER TABLE garantia.subrogacion DROP CONSTRAINT IF EXISTS fk_subrogacion_deuda_id;
ALTER TABLE garantia.subrogacion
