...
ALTER TABLE entregas.confirmacion_recepcion DROP CONSTRAINT IF EXISTS fk_confirmacion_recepcion_token_confirmacion_id;
ALTER TABLE entregas.confirmacion_recepcion
...
ALTER TABLE entregas.cuenta_bancaria_beneficiario DROP CONSTRAINT IF EXISTS fk_cuenta_bancaria_beneficiario_usuario_id;
...
ALTER TABLE entregas.deduccion_entrega DROP CONSTRAINT IF EXISTS fk_deduccion_entrega_entrega_id;
ALTER TABLE entregas.deduccion_entrega
  ADD CONSTRAINT fk_deduccion_entrega_entrega_id
  FOREIGN KEY (entrega_id) REFERENCES entregas.entrega_fondo (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE entregas.entrega_fondo DROP CONSTRAINT IF EXISTS fk_entrega_fondo_autorizada_por;
...
ALTER TABLE entregas.entrega_fondo DROP CONSTRAINT IF EXISTS fk_entrega_fondo_beneficiario_participante_id;
ALTER TABLE entregas.entrega_fondo
...
ALTER TABLE entregas.entrega_fondo DROP CONSTRAINT IF EXISTS fk_entrega_fondo_cuenta_destino_id;
ALTER TABLE entregas.entrega_fondo
...
ALTER TABLE entregas.entrega_fondo DROP CONSTRAINT IF EXISTS fk_entrega_fondo_cupo_id;
ALTER TABLE entregas.entrega_fondo
...
ALTER TABLE entregas.entrega_fondo DROP CONSTRAINT IF EXISTS fk_entrega_fondo_ejecutada_por;
ALTER TABLE entregas.entrega_fondo
...
ALTER TABLE entregas.entrega_fondo DROP CONSTRAINT IF EXISTS fk_entrega_fondo_grupo_id;
ALTER TABLE entregas.entrega_fondo
...
ALTER TABLE entregas.entrega_fondo DROP CONSTRAINT IF EXISTS fk_entrega_fondo_periodo_id;
ALTER TABLE entregas.entrega_fondo
...
ALTER TABLE entregas.entrega_fondo DROP CONSTRAINT IF EXISTS fk_entrega_fondo_turno_id;
ALTER TABLE entregas.entrega_fondo
...
ALTER TABLE entregas.historial_estado_entrega DROP CONSTRAINT IF EXISTS fk_historial_estado_entrega_entrega_id;
ALTER TABLE entregas.historial_estado_entrega
  ADD CONSTRAINT fk_historial_estado_entrega_entrega_id
  FOREIGN KEY (entrega_id) REFERENCES entregas.entrega_fondo (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE entregas.incidencia_entrega DROP CONSTRAINT IF EXISTS fk_incidencia_entrega_asignada_a;
...
ALTER TABLE entregas.incidencia_entrega DROP CONSTRAINT IF EXISTS fk_incidencia_entrega_entrega_id;
ALTER TABLE entregas.incidencia_entrega
  ADD CONSTRAINT fk_incidencia_entrega_entrega_id
  FOREIGN KEY (entrega_id) REFERENCES entregas.entrega_fondo (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE entregas.incidencia_entrega DROP CONSTRAINT IF EXISTS fk_incidencia_entrega_reportada_por;
ALTER TABLE entregas.incidencia_entrega
...
ALTER TABLE entregas.intento_desembolso DROP CONSTRAINT IF EXISTS fk_intento_desembolso_orden_desembolso_id;
...
ALTER TABLE entregas.orden_desembolso DROP CONSTRAINT IF EXISTS fk_orden_desembolso_entrega_id;
ALTER TABLE entregas.orden_desembolso
  ADD CONSTRAINT fk_orden_desembolso_entrega_id
  FOREIGN KEY (entrega_id) REFERENCES entregas.entrega_fondo (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE entregas.orden_desembolso DROP CONSTRAINT IF EXISTS fk_orden_desembolso_proveedor_id;
ALTER TABLE entregas.orden_desembolso
...
ALTER TABLE entregas.validacion_pre_entrega DROP CONSTRAINT IF EXISTS fk_validacion_pre_entrega_entrega_id;
ALTER TABLE entregas.validacion_pre_entrega
  ADD CONSTRAINT fk_validacion_pre_entrega_entrega_id
  FOREIGN KEY (entrega_id) REFERENCES entregas.entrega_fondo (id) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE entregas.validacion_pre_entrega DROP CONSTRAINT IF EXISTS fk_validacion_pre_entrega_omitida_por;
ALTER TABLE entregas.validacion_pre_entrega
...
ALTER TABLE entregas.validacion_pre_entrega DROP CONSTRAINT IF EXISTS fk_validacion_pre_entrega_regla_id;
ALTER TABLE entregas.validacion_pre_entrega
