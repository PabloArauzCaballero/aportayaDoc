 ...
 */
@AnalyzeClasses(packages = "bo.aportaya.nucleofinanciero")
class ArquitecturaTest {
    ...
    static final ArchRule ningunImportCruzado =
        noClasses().that().resideInAPackage("bo.aportaya.nucleofinanciero..")
            .should().dependOnClassesThat()
            .resideInAnyPackage("bo.aportaya..")
            .andShould().dependOnClassesThat()
            .resideOutsideOfPackages("bo.aportaya.nucleofinanciero..", "bo.aportaya.plataforma..");
