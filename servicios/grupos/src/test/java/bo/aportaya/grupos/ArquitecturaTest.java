 ...
 */
@AnalyzeClasses(packages = "bo.aportaya.grupos")
class ArquitecturaTest {
    ...
    static final ArchRule ningunImportCruzado =
        noClasses().that().resideInAPackage("bo.aportaya.grupos..")
            .should().dependOnClassesThat()
            .resideInAnyPackage("bo.aportaya..")
            .andShould().dependOnClassesThat()
            .resideOutsideOfPackages("bo.aportaya.grupos..", "bo.aportaya.plataforma..");
