...
class ArranqueTest {
    ...
    private static final java.util.List<String> PREFIJOS = java.util.List.of("/reputacion", "/publico", "/verificar");
    ...
    static void configuracion(DynamicPropertyRegistry registro) {
        ...
        // Del almacen de secretos en produccion. Aca, un valor de prueba: lo que se
        // comprueba es que el proceso EXIGE la clave, no cual es.
        registro.add("CERTIFICADOS_CLAVE_FIRMA", () -> "clave-de-prueba-no-es-un-secreto-real");
    }
