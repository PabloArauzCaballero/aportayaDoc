 ...
 */
@AnalyzeClasses(packages = "bo.aportaya.transparencia")
class ArquitecturaTest {
    ...
    static final ArchRule ningunImportCruzado =
        noClasses().that().resideInAPackage("bo.aportaya.transparencia..")
            .should().dependOnClassesThat()
            .resideInAnyPackage("bo.aportaya..")
            .andShould().dependOnClassesThat()
            .resideOutsideOfPackages("bo.aportaya.transparencia..", "bo.aportaya.plataforma..");
