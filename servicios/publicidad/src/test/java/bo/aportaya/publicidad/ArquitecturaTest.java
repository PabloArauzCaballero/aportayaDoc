 ...
 */
@AnalyzeClasses(packages = "bo.aportaya.publicidad")
class ArquitecturaTest {
    ...
    static final ArchRule ningunImportCruzado =
        noClasses().that().resideInAPackage("bo.aportaya.publicidad..")
            .should().dependOnClassesThat()
            .resideInAnyPackage("bo.aportaya..")
            .andShould().dependOnClassesThat()
            .resideOutsideOfPackages("bo.aportaya.publicidad..", "bo.aportaya.plataforma..");
