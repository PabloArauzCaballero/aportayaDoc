...
class ArranqueTest {
    ...
    private static final java.util.List<String> PREFIJOS = java.util.List.of("/notificaciones");
    ...
    static void configuracion(DynamicPropertyRegistry registro) {
        ...
        // Del almacen de secretos en produccion. Lo que se comprueba aca es que el
        // proceso lo EXIGE: sin el, el webhook aceptaria cualquier acuse.
        registro.add("WEBHOOK_SECRETO", () -> "secreto-de-prueba-solo-para-pruebas");
    }
