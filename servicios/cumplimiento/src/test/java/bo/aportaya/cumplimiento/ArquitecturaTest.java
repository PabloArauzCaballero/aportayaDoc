 ...
 */
@AnalyzeClasses(packages = "bo.aportaya.cumplimiento")
class ArquitecturaTest {
    ...
    static final ArchRule ningunImportCruzado =
        noClasses().that().resideInAPackage("bo.aportaya.cumplimiento..")
            .should().dependOnClassesThat()
            .resideInAnyPackage("bo.aportaya..")
            .andShould().dependOnClassesThat()
            .resideOutsideOfPackages("bo.aportaya.cumplimiento..", "bo.aportaya.plataforma..");
